...
export async function POST(request: Request) {
  ...
  const systemContent = `You are a senior strategic CFO copilot and equity research analyst. The user is viewing a Finbud Pro page that provides structured financial analysis.${cfoSection}
