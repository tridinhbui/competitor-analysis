...
export const DEMO_TICKERS: MockTicker[] = [
  ...
  { symbol: "DELI", price: "74.8", changePct: 1.12, spark: [0.5, 0.48, 0.52, 0.49, 0.55, 0.53, 0.58, 0.61, 0.59, 0.64] },
  ...
  { symbol: "PROTEIN", price: "119.7", changePct: 0.18, spark: [0.55, 0.56, 0.54, 0.57, 0.56, 0.58, 0.57, 0.59, 0.6, 0.58] },
];
