...
function makeAnalysis(overrides?: Partial<FullAnalysis["meta"]>): FullAnalysis {
  return {
    ...
    incomeStatement: {
      ...
      sgaExpense: null, rdExpense: null, operatingExpenses: null,
      operatingIncome: null, operatingMargin: null, ebit: null, ebitMargin: null,
      depreciation: null, amortization: null, ebitda: null, ebitdaMargin: null,
      interestExpense: null, incomeTax: null, netIncome: null, netMargin: null,
      epsBasic: null, epsDiluted: null,
    },
    cfItems: [
